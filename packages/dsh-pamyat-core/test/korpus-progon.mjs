...
// Прогон по /opt/iskra/pamyat/pamyat.db дал 0 из 116 записей, и это ответ не про правило,
...
// (putOtklonennyh, у нас /opt/iskra/pamyat/otklonennye-svodki) — там лежит ровно то, что
